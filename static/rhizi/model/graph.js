...
function Graph(spec) {
    ...
    this.update_node = function(node, new_node_spec, on_success, on_error) {
		...
		console.log('graph: attr_diff:'+attr_diff);
        rz_api_backend.commit_diff__attr(attr_diff, on_ajax_success, on_ajax_error);
    }
	...
	*/
	// @ajax-trans
	function query_from_backend(on_success,query) {
		...
		rz_api_backend.query(query, on_success__ajax);
	}
	this.query_from_backend = query_from_backend;
